 ...
 //****************************************************************************************************************************
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_0 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[7] * age_0 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[8] * age_0 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[9] * age_0 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
 ...
 //****************************************************************************************************************************
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_1 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[7] * age_1 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[8] * age_1 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[9] * age_1 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_1 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[7] * age_1 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[8] * age_1 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[9] * age_1 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
 ...
 //****************************************************************************************************************************
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_2 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[7] * age_2 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[8] * age_2 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[9] * age_2 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_2 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[7] * age_2 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[8] * age_2 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[9] * age_2 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
 ...
 //****************************************************************************************************************************
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_3 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[7] * age_3 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[8] * age_3 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[9] * age_3 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_3 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[7] * age_3 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[8] * age_3 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[9] * age_3 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
 ...
 //****************************************************************************************************************************
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_4 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[7] * age_4 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[8] * age_4 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[9] * age_4 * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 6 infected smc
             ...
             lprob[a] = log( (alpha[6] * age_4 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[7] * age_4 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[8] * age_4 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[9] * age_4 * llin * ((1 - ((exp(-(RT[a]/lambda)^k)))))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
