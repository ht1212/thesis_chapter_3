 ...
 //****************************************************************************************************************************
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
              lprob[a] = log( (alpha[2] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[3] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[4] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[5] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[6] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[7] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[8] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( (alpha[9] * age_0 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 0){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
...
//*********************************************************************************************************************************************************** 
   ...
   //************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( (alpha[6] * age_1) * exp(-(alpha[6] * age_1 * RT[a]))); 
     } 
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( (alpha[7] * age_1) * exp(-(alpha[7] * age_1 * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( (alpha[8] * age_1) * exp(-(alpha[8] * age_1 * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( (alpha[9] * age_1) * exp(-(alpha[9] * age_1 * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[6] * age_1 * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[7] * age_1 * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[8] * age_1 * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[9] * age_1 * RT[a]))); 
     }
 ...
 //****************************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( (alpha[6] * age_1 * llin) * exp(-(alpha[6] * age_1 * llin * RT[a]))); 
     }
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( (alpha[7] * age_1 * llin) * exp(-(alpha[7] * age_1 * llin * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( (alpha[8] * age_1 * llin) * exp(-(alpha[8] * age_1 * llin * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( (alpha[9] * age_1 * llin) * exp(-(alpha[9] * age_1 * llin * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[6] * age_1 * llin * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[7] * age_1 * llin * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[8] * age_1 * llin * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 1){
              lprob[a] = log( exp(-(alpha[9] * age_1 * llin * RT[a]))); 
     }    
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
              lprob[a] = log( (alpha[2] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[3]  * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[4] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[5] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[6] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[7] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[8] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( (alpha[9] * age_1 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
              lprob[a] = log( (alpha[2] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[3] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[4] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[5] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[6] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[7] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[8] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( (alpha[9] * age_1 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 1){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
...
//*********************************************************************************************************************************************************** 
   ...
   //************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( (alpha[6] * age_2) * exp(-(alpha[6] * age_2 * RT[a]))); 
     } 
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( (alpha[7] * age_2) * exp(-(alpha[7] * age_2 * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( (alpha[8] * age_2) * exp(-(alpha[8] * age_2 * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( (alpha[9] * age_2) * exp(-(alpha[9] * age_2 * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[6] * age_2 * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[7] * age_2 * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[8] * age_2 * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[9] * age_2 * RT[a]))); 
     }
 ...
 //****************************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( (alpha[6] * age_2 * llin) * exp(-(alpha[6] * age_2 * llin * RT[a]))); 
     }
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( (alpha[7] * age_2 * llin) * exp(-(alpha[7] * age_2 * llin * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( (alpha[8] * age_2 * llin) * exp(-(alpha[8] * age_2 * llin * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( (alpha[9] * age_2 * llin) * exp(-(alpha[9] * age_2 * llin * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[6] * age_2 * llin * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[7] * age_2 * llin * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[8] * age_2 * llin * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 2){
              lprob[a] = log( exp(-(alpha[9] * age_2 * llin * RT[a]))); 
     }    
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
              lprob[a] = log( (alpha[2] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[3]  * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[4] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[5] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[6] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[7] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[8] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( (alpha[9] * age_2 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
              lprob[a] = log( (alpha[2] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[3] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[4] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[5] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[6] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[7] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[8] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( (alpha[9] * age_2 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 2){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
...
//*********************************************************************************************************************************************************** 
   ...
   //************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( (alpha[6] * age_3) * exp(-(alpha[6] * age_3 * RT[a]))); 
     } 
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( (alpha[7] * age_3) * exp(-(alpha[7] * age_3 * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( (alpha[8] * age_3) * exp(-(alpha[8] * age_3 * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( (alpha[9] * age_3) * exp(-(alpha[9] * age_3 * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[6] * age_3 * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[7] * age_3 * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[8] * age_3 * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[9] * age_3 * RT[a]))); 
     }
 ...
 //****************************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( (alpha[6] * age_3 * llin) * exp(-(alpha[6] * age_3 * llin * RT[a]))); 
     }
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( (alpha[7] * age_3 * llin) * exp(-(alpha[7] * age_3 * llin * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( (alpha[8] * age_3 * llin) * exp(-(alpha[8] * age_3 * llin * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( (alpha[9] * age_3 * llin) * exp(-(alpha[9] * age_3 * llin * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[6] * age_3 * llin * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[7] * age_3 * llin * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[8] * age_3 * llin * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 3){
              lprob[a] = log( exp(-(alpha[9] * age_3 * llin * RT[a]))); 
     }    
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
              lprob[a] = log( (alpha[2] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[3]  * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[4] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[5] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[6] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[7] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[8] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( (alpha[9] * age_3 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
              lprob[a] = log( (alpha[2] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[3] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[4] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[5] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[6] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[7] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[8] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( (alpha[9] * age_3 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 3){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
...
//*********************************************************************************************************************************************************** 
   ...
   //************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( (alpha[6] * age_4) * exp(-(alpha[6] * age_4 * RT[a]))); 
     } 
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( (alpha[7] * age_4) * exp(-(alpha[7] * age_4 * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( (alpha[8] * age_4) * exp(-(alpha[8] * age_4 * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( (alpha[9] * age_4) * exp(-(alpha[9] * age_4 * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[6] * age_4 * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[7] * age_4 * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[8] * age_4 * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 0 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[9] * age_4 * RT[a]))); 
     }
 ...
 //****************************************************************************************************************************
     ...
     // interval 6 infected control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( (alpha[6] * age_4 * llin) * exp(-(alpha[6] * age_4 * llin * RT[a]))); 
     }
     // interval 7 infected control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( (alpha[7] * age_4 * llin) * exp(-(alpha[7] * age_4 * llin * RT[a]))); 
     }
     // interval 8 infected control
      else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( (alpha[8] * age_4 * llin) * exp(-(alpha[8] * age_4 * llin * RT[a]))); 
     }
     // interval 9 infected control
      else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 1 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( (alpha[9] * age_4 * llin) * exp(-(alpha[9] * age_4 * llin * RT[a]))); 
     }
     // interval 1 censored control 
     ...
     // interval 6 censored control
      else if(interval[a] == 6 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[6] * age_4 * llin * RT[a]))); 
     }
     // interval 7 censored control
      else if(interval[a] == 7 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[7] * age_4 * llin * RT[a]))); 
     }
     // interval 8 censored control
     else if(interval[a] == 8 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[8] * age_4 * llin * RT[a]))); 
     }
     // interval 9 censored control
     else if(interval[a] == 9 && treatment_id[a] == 0 && indicator[a] == 0 && bed_net[a] == 1 && age[a] == 4){
              lprob[a] = log( exp(-(alpha[9] * age_4 * llin * RT[a]))); 
     }    
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
              lprob[a] = log( (alpha[2] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[3]  * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[4] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[5] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[6] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[7] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[8] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( (alpha[9] * age_4 * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 0  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
  ...
  //********************************************************************************************************************************
     ...
     // interval 1 infected smc 
             ...
             lprob[a] = log( (alpha[1] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(-( ( p_spaq_cum[a]))) ); 
     }
     // interval 2 infected smc 
      else if(interval[a] == 2 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
              lprob[a] = log( (alpha[2] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) * exp(- ( ( p_spaq_cum[a])) )); 
     }
     // interval 3 infected smc 
      else if(interval[a] == 3 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[3] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 4 infected smc
     else if(interval[a] == 4 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[4] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 5 infected smc
     else if(interval[a] == 5 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[5] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 6 infected smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[6] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );  
     }
     // interval 7 infected smc 
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[7] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 8 infected smc 
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[8] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) ); 
     }
     // interval 9 infected smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 1 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( (alpha[9] * age_4 * llin * (1 - (1 - ((1/tgamma(k)) * gamma_p(k, RT[a]/theta)) ))) *  exp(- ( ( p_spaq_cum[a]))) );
     }
     ...
     // interval 6 censored smc
     else if(interval[a] == 6 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 7 censored smc
     else if(interval[a] == 7 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 8 censored smc
     else if(interval[a] == 8 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
     // interval 9 censored smc
     else if(interval[a] == 9 && treatment_id[a] == 1 && indicator[a] == 0 && bed_net[a] == 1  && age[a] == 4){
             lprob[a] = log( exp(- ( ( p_spaq_cum[a]) )) );   
     }
...
for(i in 1:Ti){
      p_spaq_t[i] = (1 - (1 - ((1/tgamma(k)) * gamma_p(k, time_seq[i]/theta)) )); //- (1-exp(-(time_seq[i]-1/theta)^k));
}
...
for(j in 1:N){
 ...
 else if(interval[j] == 6 && bed_net[j] == 0  && age[j] == 0){
     p_spaq_cum[j] = alpha[6] * age_0 * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 0  && age[j] == 0){
     p_spaq_cum[j] = alpha[7] * age_0 * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 0  && age[j] == 0){
     p_spaq_cum[j] = alpha[8] * age_0 * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 0  && age[j] == 0){
     p_spaq_cum[j] = alpha[9] * age_0 * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
 // yes bet net  
 ...
 else if(interval[j] == 6 && bed_net[j] == 1  && age[j] == 0){
     p_spaq_cum[j] = alpha[6] * age_0 * llin * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 1  && age[j] == 0){
     p_spaq_cum[j] = alpha[7] * age_0 * llin * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 1  && age[j] == 0){
     p_spaq_cum[j] = alpha[8] * age_0 * llin * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 1  && age[j] == 0){
     p_spaq_cum[j] = alpha[9] * age_0 * llin * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
...
// AGE GROUP 1
 ...
 else if(interval[j] == 6 && bed_net[j] == 0  && age[j] == 1){
     p_spaq_cum[j] = alpha[6] * age_1 * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 0  && age[j] == 1){
     p_spaq_cum[j] = alpha[7] * age_1 * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 0  && age[j] == 1){
     p_spaq_cum[j] = alpha[8] * age_1 * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 0  && age[j] == 1){
     p_spaq_cum[j] = alpha[9] * age_1 * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
 // yes bet net  
 ...
 else if(interval[j] == 6 && bed_net[j] == 1  && age[j] == 1){
     p_spaq_cum[j] = alpha[6] * age_1 * llin * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 1  && age[j] == 1){
     p_spaq_cum[j] = alpha[7] * age_1 * llin * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 1  && age[j] == 1){
     p_spaq_cum[j] = alpha[8] * age_1 * llin * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 1  && age[j] == 1){
     p_spaq_cum[j] = alpha[9] * age_1 * llin * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
...
// AGE GROUP 2
 ...
 else if(interval[j] == 6 && bed_net[j] == 0  && age[j] == 2){
     p_spaq_cum[j] = alpha[6] * age_2 * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 0  && age[j] == 2){
     p_spaq_cum[j] = alpha[7] * age_2 * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 0  && age[j] == 2){
     p_spaq_cum[j] = alpha[8] * age_2 * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 0  && age[j] == 2){
     p_spaq_cum[j] = alpha[9] * age_2 * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
 // yes bet net  
 ...
 else if(interval[j] == 6 && bed_net[j] == 1  && age[j] == 2){
     p_spaq_cum[j] = alpha[6] * age_2 * llin * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 1  && age[j] == 2){
     p_spaq_cum[j] = alpha[7] * age_2 * llin * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 1  && age[j] == 2){
     p_spaq_cum[j] = alpha[8] * age_2 * llin * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 1  && age[j] == 2){
     p_spaq_cum[j] = alpha[9] * age_2 * llin * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
...
// AGE GROUP 3
 ...
 else if(interval[j] == 6 && bed_net[j] == 0  && age[j] == 3){
     p_spaq_cum[j] = alpha[6] * age_3 * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 0  && age[j] == 3){
     p_spaq_cum[j] = alpha[7] * age_3 * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 0  && age[j] == 3){
     p_spaq_cum[j] = alpha[8] * age_3 * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 0  && age[j] == 3){
     p_spaq_cum[j] = alpha[9] * age_3 * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
 // yes bet net  
 ...
 else if(interval[j] == 6 && bed_net[j] == 1  && age[j] == 3){
     p_spaq_cum[j] = alpha[6] * age_3 * llin * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 1  && age[j] == 3){
     p_spaq_cum[j] = alpha[7] * age_3 * llin * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 1  && age[j] == 3){
     p_spaq_cum[j] = alpha[8] * age_3 * llin * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 1  && age[j] == 3){
     p_spaq_cum[j] = alpha[9] * age_3 * llin * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
 ...
 else if(interval[j] == 6 && bed_net[j] == 0  && age[j] == 4){
     p_spaq_cum[j] = alpha[6] * age_4 * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 0  && age[j] == 4){
     p_spaq_cum[j] = alpha[7] * age_4 * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 0  && age[j] == 4){
     p_spaq_cum[j] = alpha[8] * age_4 * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 0  && age[j] == 4){
     p_spaq_cum[j] = alpha[9] * age_4 * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
 // yes bet net  
 ...
 else if(interval[j] == 6 && bed_net[j] == 1  && age[j] == 4){
     p_spaq_cum[j] = alpha[6] * age_4 * llin * sum(p_spaq_t[break_ids[5]:time_id[j]]);
 }
 else if(interval[j] == 7 && bed_net[j] == 1  && age[j] == 4){
     p_spaq_cum[j] = alpha[7] * age_4 * llin * sum(p_spaq_t[break_ids[6]:time_id[j]]);
 }
 else if(interval[j] == 8 && bed_net[j] == 1  && age[j] == 4){
     p_spaq_cum[j] = alpha[8] * age_4 * llin * sum(p_spaq_t[break_ids[7]:time_id[j]]);
 }
 else if(interval[j] == 9 && bed_net[j] == 1  && age[j] == 4){
     p_spaq_cum[j] = alpha[9] * age_4 * llin * sum(p_spaq_t[break_ids[8]:time_id[j]]);
 }
